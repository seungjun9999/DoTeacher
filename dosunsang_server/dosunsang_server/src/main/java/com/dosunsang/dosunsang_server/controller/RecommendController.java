...
public class RecommendController {
    ...
    public ArrayList<Integer> recommend(@RequestBody UserDto user, @RequestParam Integer robotId) throws IOException {
        ...
        if(session != null) {
            session.sendMessage(new TextMessage("recommend complete"));
        }
        else {
            log.info("null");
            return null;
