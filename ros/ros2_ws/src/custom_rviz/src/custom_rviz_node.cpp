...
int main(int argc, char *argv[]) {
  ...
  auto stop_scan_service =
    [&laser](const std::shared_ptr<rmw_request_id_t> request_header [[maybe_unused]],
  const std::shared_ptr<std_srvs::srv::Empty::Request> req [[maybe_unused]],
  std::shared_ptr<std_srvs::srv::Empty::Response> response [[maybe_unused]]) -> bool
  {
